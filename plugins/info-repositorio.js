...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/BrunoSobrino/ᴘᴅᴀ   ʙᴏᴛ');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://www.instagram.com/idk_a_normal_user?igsh=MXdnbTQ3eGlsdTFkNA=='}_`;
